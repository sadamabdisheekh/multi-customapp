        ...
        return Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
              Text('Bariis', style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ...
                      child: Row(children: [
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          1==1 ? Checkbox(
                            ...
                            value: i,
                            groupValue: null, //itemController.selectedVariations[index].indexOf(true),
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            child: Center(child: Icon(
                                (2 > 1) ? Icons.remove : Icons.delete_outline_outlined, size: 18,
                              color: (2 > 1) ? Theme.of(context).primaryColor : Theme.of(context).colorScheme.error,
                            )),
                          ),
                        ),
                        Text(
