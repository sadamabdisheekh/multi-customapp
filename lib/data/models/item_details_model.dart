...
class ItemDetailsModel extends Equatable {
  ...
  factory ItemDetailsModel.fromMap(Map<String, dynamic> map) {
    return ItemDetailsModel(
      ...
      attributes: List<Attribute>.from((map['attributes'] as List<dynamic>).map<Attribute>((x) => Attribute.fromMap(x as Map<String,dynamic>),),),
    );
  }
  ...
  @override
  String toString() => 'ItemDetailsModel(itemStore: $itemStore, attributes: $attributes)';
